...
- The coefficient on nacc_neutral_beta is significant at the $\alpha = .001$ level. The p-value is .002. This means that, assuming the null hypothesis is true, the probability of observing a Wald statistic as extreme as 3.046 is .002. Here, the null hypothesis is that the coefficient on `nacc_neutral_beta` is 0. 
...
- Note that here, we run 10 hypothesis tests. Therefore, if the null is true, we should expect 5\% of our tests (half of a test) to be significant at the $\alpha = .05$ level.  
